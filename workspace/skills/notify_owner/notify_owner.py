...
# 定数 - skills/notify_owner/ から3階層上のworkspaceルートを参照
...
def notify_error(
    ...
    return notify_owner(message, level="error", title=title, metadata=meta)
...
if __name__ == "__main__":
    print("Testing notify_owner skill...")
    ...
    notify_task_complete(
        task_id="TEST-001",
        task_name="Notify Owner Skill Migration",
        result="success",
        details="Skill created and tested successfully."
    )
    
    print(f"Test completed. Check {OWNER_MESSAGES_PATH} for results.")
