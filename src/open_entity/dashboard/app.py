...
try:
    ...
    from open_entity.common.schemas import LogEntry
    from open_entity.common.errors import setup_exception_handlers
...
def create_dashboard_app(
    ...
    def get_session_logger():
        ...
        if _session_logger is None:
            try:
                from open_entity.storage import SessionLogger
    ...
    def get_cost_tracker():
        ...
        if _cost_tracker is None:
            try:
                from open_entity.core import get_cost_tracker
    ...
    async def list_agents():
        ...
        try:
            ...
            from open_entity.tools.discovery import AgentLoader
            loader = AgentLoader()
