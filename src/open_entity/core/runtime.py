...
"""
    ...
    async def run(self, user_input: str, history: Optional[List[Any]] = None, session_id: Optional[str] = None) -> str:
        ...
        if session_id:
            try:
                from open_entity.tools import todo
    ...
    def _record_cost(self) -> None:
        ...
        if not self.last_usage:
            return
        try:
            from open_entity.core.cost_tracker import get_cost_tracker, TokenUsage
            from open_entity.storage.usage_store import get_usage_store
